...
public class DBService extends SQLiteOpenHelper {
    ...
    String LIGHT="create table light(id integer primary key autoincrement,number,name,location,state,ip);";
    String LIADD="insert into light(number,name,location,state) values('001','主灯','卧室','0');";

    //智能门锁【锁编号 | 锁密码 | 锁状态】
    String LOCK="create table lock(id integer primary key autoincrement,number,password,state,ip);";
    String LOADD="insert into lock(number,password,state) values('001','123456','0')";

    //智能空调【空调编号 | 空调名字 | 空调位置 | 空调温度 | 空调状态】
    String AIR="create table air(id integer primary key autoincrement,number,name,location,temperature,state,ip);";
    ...
    String HEATER="create table heater(id integer primary key autoincrement,number,name,temperature,state,ip);";
